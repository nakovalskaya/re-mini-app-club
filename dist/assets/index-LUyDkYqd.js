...
function TabBar({ items }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "safe-bottom fixed inset-x-0 bottom-0 z-50 mx-auto flex w-full max-w-md justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full items-center justify-between rounded-[26px] border border-border-soft bg-[rgba(255,248,247,0.92)] px-3 py-3 shadow-floating backdrop-blur", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    NavLink,
    {
      to: item.to,
...
const ROUTE_HOME = "/";
const ROUTE_CATEGORY = "/category/:slug";
const ROUTE_TOPIC = "/topic/:slug";
const ROUTE_CHALLENGES = "/challenges";
const ROUTE_CHALLENGE_DETAILS = "/challenges/:id";
const ROUTE_FAVORITES = "/favorites";
const ROUTE_CLUB = "/club";
const ROUTE_CALENDAR_DAY = "/calendar/:date";
const tabBarItems = [
...
initTelegramWebApp();
function AppShell() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "screen-shell safe-top", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "screen-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabBar, { items: tabBarItems })
  ] });
}
const variantClasses = {
  primary: "bg-accent-deep text-bg-base shadow-soft hover:bg-[#4f0202] active:bg-[#480202]",
  secondary: "border border-border-medium bg-bg-surface text-text-primary hover:bg-bg-soft active:bg-[#f1e6e5]",
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card space-y-4 p-card text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-bg-soft text-accent-deep", children: icon ?? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "✦" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-text-primary", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-6 text-text-secondary", children: description })
    ] }),
    actionLabel && onAction ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", onClick: onAction, children: actionLabel }) : null
  ] });
}
function SectionTitle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex items-start justify-between gap-4", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      description ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-[34ch] text-sm leading-6 text-text-secondary", children: description }) : null
    ] }),
    action
  ] });
}
function CalendarDayScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: `Материалы дня: ${date ?? "—"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
...
function CategoryScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: `Категория: ${slug ?? "—"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
...
function ProgressBar({ value, max }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm text-text-secondary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Прогресс" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-full overflow-hidden rounded-full bg-bg-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function ChallengeDetailsScreen() {
  const { id } = useParams();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: `Челлендж: ${id ?? "—"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card space-y-4 p-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-secondary", children: "Пример состояния progress bar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: 3, max: 7 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
...
function ChallengesScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "Челленджи" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
...
const clubPage = {
  title: "О клубе",
  summary: "Правила и логика клуба в спокойной, понятной форме.",
  content: "Материалы открываются постепенно, чтобы участник мог двигаться без перегруза. Клуб устроен как маршрут: смотреть, сохранять, возвращаться и внедрять в практику."
};
function ClubScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: clubPage.title, description: clubPage.summary }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "surface-card p-card text-base leading-7 text-text-secondary", children: clubPage.content })
  ] });
}
function FavoritesScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "Избранное" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        title: "Пока пусто",
...
function HomeScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card-elevated overflow-hidden bg-accent-deep px-card py-8 text-bg-base", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-3 text-xs font-medium uppercase tracking-[0.24em] text-accent-gold", children: "Закрытый клуб" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-4xl leading-none", children: "MetaMarketing" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-[28ch] text-sm leading-6 text-[#f7e7e4]", children: "Фундамент MVP уже поднят: дальше на этот каркас будем собирать брендовый интерфейс экрана за экраном." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.16em] text-text-secondary", children: category.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-lg font-semibold text-text-primary", children: category.title })
    ] }, category.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card space-y-3 p-card text-sm text-text-secondary", children: [
...
function TopicScreen() {
  const { slug } = useParams();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: `Тема: ${slug ?? "—"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
...
const router = createBrowserRouter([
  {
    ...
    children: [
      { index: true, element: /* @__PURE__ */ jsxRuntimeExports.jsx(HomeScreen, {}) },
      { path: ROUTE_CATEGORY, element: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryScreen, {}) },
      { path: ROUTE_TOPIC, element: /* @__PURE__ */ jsxRuntimeExports.jsx(TopicScreen, {}) },
      { path: ROUTE_CHALLENGES, element: /* @__PURE__ */ jsxRuntimeExports.jsx(ChallengesScreen, {}) },
      { path: ROUTE_CHALLENGE_DETAILS, element: /* @__PURE__ */ jsxRuntimeExports.jsx(ChallengeDetailsScreen, {}) },
      { path: ROUTE_FAVORITES, element: /* @__PURE__ */ jsxRuntimeExports.jsx(FavoritesScreen, {}) },
      { path: ROUTE_CLUB, element: /* @__PURE__ */ jsxRuntimeExports.jsx(ClubScreen, {}) },
      { path: ROUTE_CALENDAR_DAY, element: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDayScreen, {}) }
    ]
  }
]);
